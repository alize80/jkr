...
----config----
local bot_api_key = "242373637:AAFO0DCIZjOvLwM094uinlZFad6rxZXj6rk" --BOT TOKEN AAECny2xj2Z9xsMqXfWQn598occab_bDFNQ
local You = 179918  --ID ADMIN 98221508
local BASE_URL = "https://api.telegram.org/bot242373637:AAFO0DCIZjOvLwM094uinlZFad6rxZXj6rk"..bot_api_key
local BASE_FOLDER = ""
local start = [[ ]]
